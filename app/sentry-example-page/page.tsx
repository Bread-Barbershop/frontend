...
export default function Page() {
  ...
  useEffect(() => {
    ...
    async function runAutomaticTest() {
      Sentry.logger.info('Running automatic Sentry example page test');
      ...
      Sentry.captureException(
        new SentryExampleFrontendError(
          'This error is raised automatically on the frontend example page.'
        )
      );
      setHasSentError(true);
    }
      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            rel="noopener"
            href="https://bread-barbershop.sentry.io/issues/?project=4511936194281472"
          >
            Issues Page
          </a>
